...
def user_interface():
    info = "Данная программа позволяет создавать, редактировать и просматривать заметки.\n" \
           ...
           "sort_newest - сортировка по дате создания заметки по возрастанию\n" \
           "sort_oldest - сортировка по дате создания заметки по убыванию\n"
    print(info)
    while True:
